...
var AppComponent = /** @class */ (function () {
    function AppComponent(WebSocketServiceService) {
...
var ChatuiComponent = /** @class */ (function () {
    function ChatuiComponent(_WebSocketServiceService) {
        var _this = this;
        ...
        this.id = 0;
        this.Users = [];
        this._WebSocketServiceService.announcement$.subscribe(function (ev) {
            if (ev) {
                _this.Announcement.unshift(ev);
            }
        });
        this._WebSocketServiceService.Message$.subscribe(function (ev) {
            if (ev) {
                _this.Messages.unshift(ev);
            }
        });
        this._WebSocketServiceService.user$.subscribe(function (n) {
            _this.name = n.name;
            _this.id = n.id;
            //console.log(n.id);
        });
    }
    ChatuiComponent.prototype.ngOnInit = function () {
        this._WebSocketServiceService.StartSocket();
        this.getUsers();
    };
    ChatuiComponent.prototype.getUsers = function () {
        var _this = this;
        this._WebSocketServiceService.getUsers().subscribe(function (data) {
            _this.Users = data;
        });
    };
    ChatuiComponent.prototype.sendMsg = function () {
    ...
    ChatuiComponent.ctorParameters = function () { return [
...
var SendMsgRequest = /** @class */ (function () {
...
var WebSocketServiceService = /** @class */ (function () {
    function WebSocketServiceService(http) {
        this.http = http;
    ...
    WebSocketServiceService.prototype.addUser = function (item) {
        return this.http.post(this.url + 'createUser', item);
    };
    WebSocketServiceService.prototype.createRoom = function (id) {
        return this.http.post(this.url + '?id=' + id, id);
    };
    WebSocketServiceService.prototype.getUsers = function () {
        return this.http.get(this.url + 'Id');
    };
    WebSocketServiceService.prototype.StartSocket = function () {
        var _this = this;
        ...
        this.socket.addEventListener("message", (function (ev) {
            ...
            switch (msg.MessageType) {
                case "user":
                    _this.name = msg.Payload.name;
                    var user_1 = new _models_User__WEBPACK_IMPORTED_MODULE_0__["User"](0, msg.Payload.name, msg.Payload.socket);
                    _this.addUser(user_1).subscribe(function (res) { user_1.id = res; _this.user$.next(user_1); });
                    break;
                case "message":
                    _this.Message$.next(msg.Payload);
                    break;
                case "announce":
                    _this.announcement$.next(msg.Payload);
                    break;
                default:
                    break;
            }
    ...
    WebSocketServiceService.prototype.sendMessage = function (req) {
